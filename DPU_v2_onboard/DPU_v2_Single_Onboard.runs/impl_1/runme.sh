...
HD_PWD='D:/TH/2026au/FPGA/DPU_new/DPU_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_dpu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_dpu_wrapper.tcl -notrace
