...
HD_PWD='D:/TH/2026au/FPGA/DPU_new/DPU_new.runs/ps_dpu_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_dpu_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_dpu_rst_ps7_0_100M_0.tcl
