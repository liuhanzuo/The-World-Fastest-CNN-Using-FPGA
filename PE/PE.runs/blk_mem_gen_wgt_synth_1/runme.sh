...
HD_PWD='D:/TH/2026au/FPGA/The-World-Fastest-CNN-Using-FPGA/PE/PE.runs/blk_mem_gen_wgt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_wgt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_wgt.tcl
