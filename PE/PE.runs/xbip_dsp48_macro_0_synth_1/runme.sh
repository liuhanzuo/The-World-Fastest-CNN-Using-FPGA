...
HD_PWD='D:/TH/2026au/FPGA/The-World-Fastest-CNN-Using-FPGA/PE/PE.runs/xbip_dsp48_macro_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xbip_dsp48_macro_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xbip_dsp48_macro_0.tcl
