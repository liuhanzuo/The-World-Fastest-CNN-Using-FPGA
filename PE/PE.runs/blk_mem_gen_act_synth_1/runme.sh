...
HD_PWD='D:/FPGA/The-World-Fastest-CNN-Using-FPGA/PE/PE.runs/blk_mem_gen_act_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_act.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_act.tcl
